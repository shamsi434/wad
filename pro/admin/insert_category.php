...
if(isset($_POST['insert_category'])){
    $pro_brand=$_POST['pro_title'];
    $Query = "insert into Category(pro_category)values('$pro_title')";
    echo $Query;
    ...
    <form action="insert_brand.php" method="post">
        ...
        <div class="row my-3">
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                    <button name="insert_category" type="submit" class="btn btn-primary btn-block"><i class="fas fa-plus"></i> Insert Now </button>
                </div>
            </div>
    </form>
</div>
